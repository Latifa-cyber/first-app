                              ...
                              child: ElevatedButton(
                                  onPressed: () {
                                    if(keys.currentState!.validate()){
                                      ...
                                      somme= (((double.parse(v1.text)+double.parse(v2.text)+double.parse(v3.text)+double.parse(v4.text)+double.parse(v5.text)+double.parse(v6.text)+double.parse(v7.text)+double.parse(v8.text)+double.parse(v9.text)+double.parse(v10.text)+double.parse(v11.text)+double.parse(v12.text))*20)/12).toStringAsFixed(2);
